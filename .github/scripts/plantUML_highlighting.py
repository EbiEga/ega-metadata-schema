...
class PlantUMLFormatter:
    ...
    def format_json_paths(self, plantUML_format_dictionary: dict, add_parent_properties: bool = True) -> list:
        """
    ...
    def create_highlights_header(self) -> str:
        ...
        """
        self.highlights_header = "".join(create_highlights_liner(json_path_str) for json_path_str in self.highlight_header_list)
