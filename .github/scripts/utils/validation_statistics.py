# ------ #
# Utils for Validation statistics
# ------ #
...
class JSONDocValidationStats:
    ...
    def count_properties(self, json_dict: dict) -> Union[int, int]:
        """
...
class JSONBatchValidationStats:
    ...
    Starting attributes:
        input_directory (str): directory containing the input JSON files
        output_directory (str): directory where the validation stats will be saved
        endpoint (str): validation endpoint to use for the file validation
        stop_at_errors (bool): boolean switch to stop or not upon validation errors
    """
