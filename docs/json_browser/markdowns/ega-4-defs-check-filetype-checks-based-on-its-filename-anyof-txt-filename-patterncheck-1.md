...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/filenameFiletypePatternCheck/anyOf/46
```
...
* Type: `string` ([Filename pattern of a TXT file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-txt-filename-patterncheck-1-properties-filename-pattern-of-a-txt-file.md))
...
`string` ([Filename pattern of a TXT file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-txt-filename-patterncheck-1-properties-filename-pattern-of-a-txt-file.md))
