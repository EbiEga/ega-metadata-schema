...
unknown ([qual454 Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-qual454-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a QUAL454 file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-qual454-filename-patterncheck-properties-filename-pattern-of-a-qual454-file.md))
...
`string` ([Filename pattern of a QUAL454 file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-qual454-filename-patterncheck-properties-filename-pattern-of-a-qual454-file.md))
