...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/EGADACIdPattern
```
...
`string` ([Pattern of an EGA DAC's ID (EGAC...)](ega-4-defs-pattern-of-an-ega-dacs-id-egac.md))
