...
unknown ([MD5 Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-md5-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a MD5 file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-md5-filename-patterncheck-properties-filename-pattern-of-a-md5-file.md))
...
`string` ([Filename pattern of a MD5 file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-md5-filename-patterncheck-properties-filename-pattern-of-a-md5-file.md))
