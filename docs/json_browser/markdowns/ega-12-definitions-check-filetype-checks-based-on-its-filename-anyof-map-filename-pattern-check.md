...
*   Type: `string` ([Filename pattern of a MAP file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-map-filename-pattern-check-properties-filename-pattern-of-a-map-file.md))
...
`string` ([Filename pattern of a MAP file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-map-filename-pattern-check-properties-filename-pattern-of-a-map-file.md))
