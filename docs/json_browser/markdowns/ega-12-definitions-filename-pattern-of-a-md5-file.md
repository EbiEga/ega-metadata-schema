...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/md5-file-filename-pattern
```
...
## md5-file-filename-pattern Type

`string` ([Filename pattern of a MD5 file](ega-12-definitions-filename-pattern-of-a-md5-file.md))

## md5-file-filename-pattern Constraints
...
## md5-file-filename-pattern Examples
