...
unknown ([IDF Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-idf-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a IDF file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-idf-filename-patterncheck-properties-filename-pattern-of-a-idf-file.md))
...
`string` ([Filename pattern of a IDF file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-idf-filename-patterncheck-properties-filename-pattern-of-a-idf-file.md))
