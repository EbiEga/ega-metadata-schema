# VCF Filename patternCheck Schema
...
unknown ([VCF Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-vcf-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a VCF file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-vcf-filename-patterncheck-properties-filename-pattern-of-a-vcf-file.md))
...
`string` ([Filename pattern of a VCF file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-vcf-filename-patterncheck-properties-filename-pattern-of-a-vcf-file.md))
