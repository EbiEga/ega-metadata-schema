...
unknown ([FAM Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-fam-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a FAM file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-fam-filename-patterncheck-properties-filename-pattern-of-a-fam-file.md))
...
`string` ([Filename pattern of a FAM file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-fam-filename-patterncheck-properties-filename-pattern-of-a-fam-file.md))
