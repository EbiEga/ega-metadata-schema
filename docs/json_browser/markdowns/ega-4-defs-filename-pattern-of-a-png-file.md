...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/pngFileFilenamePattern
```
...
`string` ([Filename pattern of a PNG file](ega-4-defs-filename-pattern-of-a-png-file.md))
