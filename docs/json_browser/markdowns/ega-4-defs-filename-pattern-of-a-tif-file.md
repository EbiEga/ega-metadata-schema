...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/tifFileFilenamePattern
```
...
`string` ([Filename pattern of a TIF file](ega-4-defs-filename-pattern-of-a-tif-file.md))
