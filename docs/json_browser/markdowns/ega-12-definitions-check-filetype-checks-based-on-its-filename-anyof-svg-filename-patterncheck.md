...
unknown ([SVG Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-svg-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a SVG file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-svg-filename-patterncheck-properties-filename-pattern-of-a-svg-file.md))
...
`string` ([Filename pattern of a SVG file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-svg-filename-patterncheck-properties-filename-pattern-of-a-svg-file.md))
