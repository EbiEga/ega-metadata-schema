...
unknown ([BAS.H5 Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-bash5-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a BAS.H5 file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-bash5-filename-patterncheck-properties-filename-pattern-of-a-bash5-file.md))
...
`string` ([Filename pattern of a BAS.H5 file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-bash5-filename-patterncheck-properties-filename-pattern-of-a-bash5-file.md))
