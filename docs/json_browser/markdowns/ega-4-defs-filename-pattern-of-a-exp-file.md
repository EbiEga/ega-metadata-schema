...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/expFileFilenamePattern
```
...
`string` ([Filename pattern of a EXP file](ega-4-defs-filename-pattern-of-a-exp-file.md))
