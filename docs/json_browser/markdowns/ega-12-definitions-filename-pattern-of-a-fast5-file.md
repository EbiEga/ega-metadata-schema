...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/fast5-file-filename-pattern
```
...
## fast5-file-filename-pattern Examples
