...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/csiFileFilenamePattern
```
...
`string` ([Filename pattern of a CSI file](ega-4-defs-filename-pattern-of-a-csi-file.md))
