...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/nucleicAcidSequence
```
...
`string` ([Nucleic acid sequence](ega-4-defs-nucleic-acid-sequence.md))
