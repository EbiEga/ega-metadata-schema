...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/EGAAnalysisIdPattern
```
...
`string` ([Pattern of an EGA analysis's ID (EGAZ...)](ega-4-defs-pattern-of-an-ega-analysiss-id-egaz.md))
