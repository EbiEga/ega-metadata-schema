...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.DAC.json#/properties/dac_relationships/items/allOf/1
```
...
merged type ([Relationship constraints for a DAC](ega-8-properties-dac-relationships-items-allof-relationship-constraints-for-a-dac.md))
