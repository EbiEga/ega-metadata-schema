...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/bedFileFilenamePattern
```
...
`string` ([Filename pattern of a BED file](ega-4-definitions-filename-pattern-of-a-bed-file.md))
