# MATLAB Filename patternCheck Schema
...
unknown ([MATLAB Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-matlab-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a MATLAB file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-matlab-filename-patterncheck-properties-filename-pattern-of-a-matlab-file.md))
...
`string` ([Filename pattern of a MATLAB file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-matlab-filename-patterncheck-properties-filename-pattern-of-a-matlab-file.md))
