...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/pairFileFilenamePattern
```
...
`string` ([Filename pattern of a PAIR file](ega-4-defs-filename-pattern-of-a-pair-file.md))
