...
unknown ([SFF Filename pattern-check](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-sff-filename-pattern-check.md))
...
*   Type: `string` ([Filename pattern of a SFF file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-sff-filename-pattern-check-properties-filename-pattern-of-a-sff-file.md))
...
`string` ([Filename pattern of a SFF file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-sff-filename-pattern-check-properties-filename-pattern-of-a-sff-file.md))
