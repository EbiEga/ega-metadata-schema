...
`object` ([Check that the object_id's accession pattern and object_type match](ega-12-definitions-check-that-the-object_ids-accession-pattern-and-object_type-match.md))
