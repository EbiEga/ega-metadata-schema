...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/curie_refseq_pattern/allOf/0
```
...
`string` ([Compact URI (CURIE) pattern](ega-12-definitions-refseq-accessions-data1098-curie-pattern-allof-compact-uri-curie-pattern.md))
