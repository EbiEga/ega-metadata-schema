...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/curieHgncSymbolPattern/allOf/0
```
...
`string` ([Compact URI (CURIE) pattern](ega-4-defs-compact-uri-curie-pattern.md))
