# Filename pattern of a HAP file Schema

```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/hapFileFilenamePattern
```
...
`string` ([Filename pattern of a HAP file](ega-4-defs-filename-pattern-of-a-hap-file.md))
