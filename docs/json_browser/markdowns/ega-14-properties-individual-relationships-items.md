...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.individual.json#/properties/individual_relationships/items
```
...
merged type ([Details](ega-14-properties-individual-relationships-items.md))
