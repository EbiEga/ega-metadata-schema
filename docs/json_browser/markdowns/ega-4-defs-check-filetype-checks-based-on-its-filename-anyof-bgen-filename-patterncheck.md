...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/filenameFiletypePatternCheck/anyOf/48
```
...
*   Type: `string` ([Filename pattern of a BGEN file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-bgen-filename-patterncheck-properties-filename-pattern-of-a-bgen-file.md))
...
`string` ([Filename pattern of a BGEN file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-bgen-filename-patterncheck-properties-filename-pattern-of-a-bgen-file.md))
