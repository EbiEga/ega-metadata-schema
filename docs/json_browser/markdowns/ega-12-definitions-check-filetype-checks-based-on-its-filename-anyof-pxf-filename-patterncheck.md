...
unknown ([PXF Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-pxf-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a PXF file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-pxf-filename-patterncheck-properties-filename-pattern-of-a-pxf-file.md))
...
`string` ([Filename pattern of a PXF file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-pxf-filename-patterncheck-properties-filename-pattern-of-a-pxf-file.md))
