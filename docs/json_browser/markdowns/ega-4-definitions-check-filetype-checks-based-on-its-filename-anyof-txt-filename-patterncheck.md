...
unknown ([TXT Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-txt-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a TXT file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-txt-filename-patterncheck-properties-filename-pattern-of-a-txt-file.md))
