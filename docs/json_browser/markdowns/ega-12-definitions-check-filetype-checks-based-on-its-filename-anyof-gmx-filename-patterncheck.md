...
unknown ([GMX Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-gmx-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a GMX file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-gmx-filename-patterncheck-properties-filename-pattern-of-a-gmx-file.md))
...
`string` ([Filename pattern of a GMX file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-gmx-filename-patterncheck-properties-filename-pattern-of-a-gmx-file.md))
