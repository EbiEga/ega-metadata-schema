...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/svg-file-filename-pattern
```
...
## svg-file-filename-pattern Type

`string` ([Filename pattern of a SVG file](ega-12-definitions-filename-pattern-of-a-svg-file.md))

## svg-file-filename-pattern Constraints
...
## svg-file-filename-pattern Examples
