...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/filenameFiletypePatternCheck/anyOf/43
```
...
* Type: `string` ([Filename pattern of a HDF5 file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-hdf5-filename-patterncheck-properties-filename-pattern-of-a-hdf5-file.md))
...
`string` ([Filename pattern of a HDF5 file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-hdf5-filename-patterncheck-properties-filename-pattern-of-a-hdf5-file.md))
