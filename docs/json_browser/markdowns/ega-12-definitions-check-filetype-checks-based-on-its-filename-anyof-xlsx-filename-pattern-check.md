...
*   Type: `string` ([Filename pattern of a  file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-xlsx-filename-pattern-check-properties-filename-pattern-of-a--file.md))
...
`string` ([Filename pattern of a  file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-xlsx-filename-pattern-check-properties-filename-pattern-of-a--file.md))
