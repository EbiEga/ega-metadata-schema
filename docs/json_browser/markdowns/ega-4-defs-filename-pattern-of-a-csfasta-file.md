# Filename pattern of a CSFASTA file Schema

```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/csfastaFileFilenamePattern
```
...
`string` ([Filename pattern of a CSFASTA file](ega-4-defs-filename-pattern-of-a-csfasta-file.md))
