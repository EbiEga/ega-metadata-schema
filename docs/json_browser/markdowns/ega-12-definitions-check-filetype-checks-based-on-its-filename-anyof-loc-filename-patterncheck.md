...
unknown ([LOC Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-loc-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a LOC file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-loc-filename-patterncheck-properties-filename-pattern-of-a-loc-file.md))
...
`string` ([Filename pattern of a LOC file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-loc-filename-patterncheck-properties-filename-pattern-of-a-loc-file.md))
