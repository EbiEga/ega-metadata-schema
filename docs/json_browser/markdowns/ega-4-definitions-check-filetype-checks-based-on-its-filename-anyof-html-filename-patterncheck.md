# HTML Filename patternCheck Schema
...
unknown ([HTML Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-html-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a HTML file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-html-filename-patterncheck-properties-filename-pattern-of-a-html-file.md))
...
`string` ([Filename pattern of a HTML file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-html-filename-patterncheck-properties-filename-pattern-of-a-html-file.md))
