...
unknown ([CSV Filename pattern-check](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-csv-filename-pattern-check.md))
...
*   Type: `string` ([Filename pattern of a CSV file](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-csv-filename-pattern-check-properties-filename-pattern-of-a-csv-file.md))
...
`string` ([Filename pattern of a CSV file](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-csv-filename-pattern-check-properties-filename-pattern-of-a-csv-file.md))
