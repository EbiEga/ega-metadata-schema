...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/curieNcbiAssemblyPattern/allOf/0
```
...
`string` ([Compact URI (CURIE) pattern](ega-4-definitions-ncbi-assembly-curie-pattern-allof-compact-uri-curie-pattern.md))
