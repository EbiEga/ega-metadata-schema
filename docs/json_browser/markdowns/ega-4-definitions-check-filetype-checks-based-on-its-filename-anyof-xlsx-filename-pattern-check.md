...
unknown ([XLSX Filename pattern-check](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-xlsx-filename-pattern-check.md))
...
*   Type: `string` ([Filename pattern of a XLSX file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-xlsx-filename-pattern-check-properties-filename-pattern-of-a-xlsx-file.md))
...
`string` ([Filename pattern of a XLSX file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-xlsx-filename-pattern-check-properties-filename-pattern-of-a-xlsx-file.md))
