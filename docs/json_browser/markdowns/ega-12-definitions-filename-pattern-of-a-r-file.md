# Filename pattern of a R file Schema

```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/r-file-filename-pattern
```
...
## r-file-filename-pattern Examples
