...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/bgiFileFilenamePattern
```
...
## bgiFileFilenamePattern Type

`string` ([Filename pattern of a BGI file](ega-4-definitions-filename-pattern-of-a-bgi-file.md))

## bgiFileFilenamePattern Constraints
...
## bgiFileFilenamePattern Examples
