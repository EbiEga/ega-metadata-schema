...
unknown ([SRF Filename pattern-check](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-srf-filename-pattern-check.md))
...
*   Type: `string` ([Filename pattern of a SRF file](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-srf-filename-pattern-check-properties-filename-pattern-of-a-srf-file.md))
