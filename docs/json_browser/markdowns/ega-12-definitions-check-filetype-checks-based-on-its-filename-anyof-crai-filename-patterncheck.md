# CRAI Filename patternCheck Schema
...
unknown ([CRAI Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-crai-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a CRAI file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-crai-filename-patterncheck-properties-filename-pattern-of-a-crai-file.md))
...
`string` ([Filename pattern of a CRAI file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-crai-filename-patterncheck-properties-filename-pattern-of-a-crai-file.md))
