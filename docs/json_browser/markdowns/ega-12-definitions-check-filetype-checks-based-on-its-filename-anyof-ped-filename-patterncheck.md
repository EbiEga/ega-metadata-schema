...
unknown ([PED Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-ped-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a PED file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-ped-filename-patterncheck-properties-filename-pattern-of-a-ped-file.md))
...
`string` ([Filename pattern of a PED file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-ped-filename-patterncheck-properties-filename-pattern-of-a-ped-file.md))
