...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/locFileFilenamePattern
```
...
`string` ([Filename pattern of a LOC file](ega-4-definitions-filename-pattern-of-a-loc-file.md))
