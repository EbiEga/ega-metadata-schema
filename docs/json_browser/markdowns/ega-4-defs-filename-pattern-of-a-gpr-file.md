...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/gprFileFilenamePattern
```
...
`string` ([Filename pattern of a GPR file](ega-4-defs-filename-pattern-of-a-gpr-file.md))
