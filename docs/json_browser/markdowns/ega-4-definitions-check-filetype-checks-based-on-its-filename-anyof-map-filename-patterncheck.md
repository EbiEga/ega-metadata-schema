...
unknown ([MAP Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-map-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a MAP file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-map-filename-patterncheck-properties-filename-pattern-of-a-map-file.md))
...
`string` ([Filename pattern of a MAP file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-map-filename-patterncheck-properties-filename-pattern-of-a-map-file.md))
