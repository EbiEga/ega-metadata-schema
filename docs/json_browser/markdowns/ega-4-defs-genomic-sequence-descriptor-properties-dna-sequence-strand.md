...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/genomicSequenceDescriptor/properties/dnaSequenceStrand
```
...
`string` ([DNA Sequence strand](ega-4-defs-genomic-sequence-descriptor-properties-dna-sequence-strand.md))
