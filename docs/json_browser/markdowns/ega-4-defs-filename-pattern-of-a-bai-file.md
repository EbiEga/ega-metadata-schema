...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/baiFileFilenamePattern
```
...
`string` ([Filename pattern of a BAI file](ega-4-defs-filename-pattern-of-a-bai-file.md))
