...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/schemaDescriptor/properties/describedBySchemaUri/allOf/0
```
...
`string` ([URL/URI pattern](ega-4-definitions-schema-descriptor-properties-uri-of-the-schema-allof-urluri-pattern.md))
