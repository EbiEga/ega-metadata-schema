...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/bas.h5FileFilenamePattern
```
...
`string` ([Filename pattern of a BAS.H5 file](ega-4-defs-filename-pattern-of-a-bash5-file.md))
