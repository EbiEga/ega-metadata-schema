...
unknown ([GTC Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-gtc-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a GTC file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-gtc-filename-patterncheck-properties-filename-pattern-of-a-gtc-file.md))
...
`string` ([Filename pattern of a GTC file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-gtc-filename-patterncheck-properties-filename-pattern-of-a-gtc-file.md))
