...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/gene_descriptor/properties/gene_id_curie/allOf/0
```
...
`string` ([Compact URI (CURIE) pattern](ega-12-definitions-gene-descriptor-properties-gene-curie-id-allof-compact-uri-curie-pattern.md))
