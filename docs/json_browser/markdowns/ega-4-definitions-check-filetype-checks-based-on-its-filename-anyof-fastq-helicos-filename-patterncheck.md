...
unknown ([FASTQ-helicos Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-fastq-helicos-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a FASTQ-HELICOS file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-fastq-helicos-filename-patterncheck-properties-filename-pattern-of-a-fastq-helicos-file.md))
...
`string` ([Filename pattern of a FASTQ-HELICOS file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-fastq-helicos-filename-patterncheck-properties-filename-pattern-of-a-fastq-helicos-file.md))
