...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/curieNcbiAssemblyPattern/allOf/0
```
...
`string` ([Compact URI (CURIE) pattern](ega-4-defs-ncbi-assembly-curie-pattern-allof-compact-uri-curie-pattern.md))
