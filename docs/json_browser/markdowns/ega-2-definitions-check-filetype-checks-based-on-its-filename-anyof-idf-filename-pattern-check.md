...
unknown ([IDF Filename pattern-check](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-idf-filename-pattern-check.md))
...
*   Type: `string` ([Filename pattern of a IDF file](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-idf-filename-pattern-check-properties-filename-pattern-of-a-idf-file.md))
...
`string` ([Filename pattern of a IDF file](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-idf-filename-pattern-check-properties-filename-pattern-of-a-idf-file.md))
