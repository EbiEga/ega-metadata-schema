# PAIR Filename patternCheck Schema
...
unknown ([PAIR Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-pair-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a PAIR file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-pair-filename-patterncheck-properties-filename-pattern-of-a-pair-file.md))
...
`string` ([Filename pattern of a PAIR file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-pair-filename-patterncheck-properties-filename-pattern-of-a-pair-file.md))
