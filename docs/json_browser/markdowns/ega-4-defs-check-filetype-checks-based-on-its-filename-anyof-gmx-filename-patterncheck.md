# GMX Filename patternCheck Schema

```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/filenameFiletypePatternCheck/anyOf/69
```
...
unknown ([GMX Filename patternCheck](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-gmx-filename-patterncheck.md))

# 69 Properties

| Property              | Type          | Required | Nullable       | Defined by                                                                                                                                                                                                                                                                                                                                      |
| :-------------------- | :------------ | :------- | :------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [filetype](#filetype) | Not specified | Optional | cannot be null | [EGA common metadata definitions](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-gmx-filename-patterncheck-properties-filetype.md "https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/filenameFiletypePatternCheck/anyOf/69/properties/filetype")                       |
...
*   Type: `string` ([Filename pattern of a GMX file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-gmx-filename-patterncheck-properties-filename-pattern-of-a-gmx-file.md))
...
`string` ([Filename pattern of a GMX file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-gmx-filename-patterncheck-properties-filename-pattern-of-a-gmx-file.md))
