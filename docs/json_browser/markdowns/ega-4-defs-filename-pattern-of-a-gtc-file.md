...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/gtcFileFilenamePattern
```
...
`string` ([Filename pattern of a GTC file](ega-4-defs-filename-pattern-of-a-gtc-file.md))
