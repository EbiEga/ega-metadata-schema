...
unknown ([FASTQ Filename pattern-check](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-fastq-filename-pattern-check.md))
...
*   Type: `string` ([Filename pattern of a FASTQ file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-fastq-filename-pattern-check-properties-filename-pattern-of-a-fastq-file.md))
...
`string` ([Filename pattern of a FASTQ file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-fastq-filename-pattern-check-properties-filename-pattern-of-a-fastq-file.md))
