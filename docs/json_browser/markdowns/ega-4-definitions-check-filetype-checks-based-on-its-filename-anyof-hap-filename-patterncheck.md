...
unknown ([HAP Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-hap-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a HAP file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-hap-filename-patterncheck-properties-filename-pattern-of-a-hap-file.md))
