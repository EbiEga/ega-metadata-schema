# Filename pattern of a JPG file Schema

```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/jpg-file-filename-pattern
```
...
## jpg-file-filename-pattern Type

`string` ([Filename pattern of a JPG file](ega-12-definitions-filename-pattern-of-a-jpg-file.md))

## jpg-file-filename-pattern Constraints
...
## jpg-file-filename-pattern Examples
