...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/matlabFileFilenamePattern
```
...
`string` ([Filename pattern of a MATLAB file](ega-4-definitions-filename-pattern-of-a-matlab-file.md))
