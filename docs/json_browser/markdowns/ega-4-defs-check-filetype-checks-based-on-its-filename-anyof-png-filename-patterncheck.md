...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/filenameFiletypePatternCheck/anyOf/40
```
...
*   Type: `string` ([Filename pattern of a PNG file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-png-filename-patterncheck-properties-filename-pattern-of-a-png-file.md))
...
`string` ([Filename pattern of a PNG file](ega-4-defs-check-filetype-checks-based-on-its-filename-anyof-png-filename-patterncheck-properties-filename-pattern-of-a-png-file.md))
