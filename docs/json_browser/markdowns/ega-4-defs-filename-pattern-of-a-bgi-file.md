...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/bgiFileFilenamePattern
```
...
`string` ([Filename pattern of a BGI file](ega-4-defs-filename-pattern-of-a-bgi-file.md))
