...
unknown ([BGEN Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-bgen-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a BGEN file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-bgen-filename-patterncheck-properties-filename-pattern-of-a-bgen-file.md))
...
`string` ([Filename pattern of a BGEN file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-bgen-filename-patterncheck-properties-filename-pattern-of-a-bgen-file.md))
