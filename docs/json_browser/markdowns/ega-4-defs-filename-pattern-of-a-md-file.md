...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/mdFileFilenamePattern
```
...
`string` ([Filename pattern of a MD file](ega-4-defs-filename-pattern-of-a-md-file.md))
