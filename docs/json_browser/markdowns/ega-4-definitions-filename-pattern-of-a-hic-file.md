...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/hicFileFilenamePattern
```
...
`string` ([Filename pattern of a HIC file](ega-4-definitions-filename-pattern-of-a-hic-file.md))
