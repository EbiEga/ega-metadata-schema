...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/txtFileFilenamePattern
```
...
`string` ([Filename pattern of a TXT file](ega-4-definitions-filename-pattern-of-a-txt-file.md))
