...
unknown ([EXP Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-exp-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a EXP file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-exp-filename-patterncheck-properties-filename-pattern-of-a-exp-file.md))
...
`string` ([Filename pattern of a EXP file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-exp-filename-patterncheck-properties-filename-pattern-of-a-exp-file.md))
