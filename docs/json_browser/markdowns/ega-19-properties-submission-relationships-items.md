...
```txt
https://github.com/EbiEga/ega-metadata-schema/tree/main/schemas/EGA.submission.json#/properties/submission_relationships/items
```
...
merged type ([Details](ega-19-properties-submission-relationships-items.md))
