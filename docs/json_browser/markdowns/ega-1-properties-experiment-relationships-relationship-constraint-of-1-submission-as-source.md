...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.experiment.json#/properties/experimentRelationships/contains
```
...
merged type ([Relationship constraint of 1 submission as source](ega-1-properties-experiment-relationships-relationship-constraint-of-1-submission-as-source.md))
