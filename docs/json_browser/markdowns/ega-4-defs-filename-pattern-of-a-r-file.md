...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/rFileFilenamePattern
```
...
`string` ([Filename pattern of a R file](ega-4-defs-filename-pattern-of-a-r-file.md))
