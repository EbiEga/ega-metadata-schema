# PERL Filename patternCheck Schema
...
unknown ([PERL Filename patternCheck](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-perl-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a PERL file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-perl-filename-patterncheck-properties-filename-pattern-of-a-perl-file.md))
...
`string` ([Filename pattern of a PERL file](ega-4-definitions-check-filetype-checks-based-on-its-filename-anyof-perl-filename-patterncheck-properties-filename-pattern-of-a-perl-file.md))
