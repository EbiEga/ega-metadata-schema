...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/md5FileFilenamePattern
```
...
`string` ([Filename pattern of a MD5 file](ega-4-defs-filename-pattern-of-a-md5-file.md))
