...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.policy.json#/properties/policy_relationships/contains
```
...
merged type ([Relationship constraint of 1 submission as source](ega-16-properties-policy-relationships-relationship-constraint-of-1-submission-as-source.md))
