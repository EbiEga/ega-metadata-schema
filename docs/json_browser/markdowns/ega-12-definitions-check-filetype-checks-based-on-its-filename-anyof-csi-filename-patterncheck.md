...
unknown ([CSI Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-csi-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a CSI file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-csi-filename-patterncheck-properties-filename-pattern-of-a-csi-file.md))
...
`string` ([Filename pattern of a CSI file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-csi-filename-patterncheck-properties-filename-pattern-of-a-csi-file.md))
