...
```txt
https://github.com/EbiEga/ega-metadata-schema/tree/main/schemas/EGA.common-definitions.json#/definitions/cel-file-filename-pattern
```
...
`string` ([Filename pattern of a CEL file](ega-2-definitions-filename-pattern-of-a-cel-file.md))
