...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/rConstraintOneSourcedSubmission
```
...
merged type ([Relationship constraint of 1 submission as source](ega-4-defs-relationship-constraint-of-1-submission-as-source.md))
