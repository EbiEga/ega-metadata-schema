...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.experiment.json#/properties/experiment_relationships/contains
```
...
merged type ([Relationship constraint of 1 submission as source](ega-9-properties-experiment-relationships-relationship-constraint-of-1-submission-as-source.md))
