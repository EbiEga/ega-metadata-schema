...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/genFileFilenamePattern
```
...
`string` ([Filename pattern of a GEN file](ega-4-defs-filename-pattern-of-a-gen-file.md))
