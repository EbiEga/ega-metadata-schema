...
unknown ([MTX Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-mtx-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a MTX file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-mtx-filename-patterncheck-properties-filename-pattern-of-a-mtx-file.md))
...
`string` ([Filename pattern of a MTX file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-mtx-filename-patterncheck-properties-filename-pattern-of-a-mtx-file.md))
