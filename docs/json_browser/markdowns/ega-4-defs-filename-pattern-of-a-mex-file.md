...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/mexFileFilenamePattern
```
...
`string` ([Filename pattern of a MEX file](ega-4-defs-filename-pattern-of-a-mex-file.md))
