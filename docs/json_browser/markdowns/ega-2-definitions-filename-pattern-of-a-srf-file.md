...
```txt
https://github.com/EbiEga/ega-metadata-schema/tree/main/schemas/EGA.common-definitions.json#/definitions/srf-file-filename-pattern
```
...
`string` ([Filename pattern of a SRF file](ega-2-definitions-filename-pattern-of-a-srf-file.md))
