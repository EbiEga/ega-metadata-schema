...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/shFileFilenamePattern
```
...
`string` ([Filename pattern of a SH file](ega-4-defs-filename-pattern-of-a-sh-file.md))
