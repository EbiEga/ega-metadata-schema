...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/bax.h5FileFilenamePattern
```
...
`string` ([Filename pattern of a BAX.H5 file](ega-4-defs-filename-pattern-of-a-baxh5-file.md))
