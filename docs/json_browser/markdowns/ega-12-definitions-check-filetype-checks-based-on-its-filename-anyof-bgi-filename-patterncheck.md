...
unknown ([BGI Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-bgi-filename-patterncheck.md))
...
*   Type: `string` ([Filename pattern of a BGI file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-bgi-filename-patterncheck-properties-filename-pattern-of-a-bgi-file.md))
...
`string` ([Filename pattern of a BGI file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-bgi-filename-patterncheck-properties-filename-pattern-of-a-bgi-file.md))
