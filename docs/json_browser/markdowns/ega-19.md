...
`object` ([EGA study metadata schema](ega-19.md))
...
*   Type: `string` ([Title of the study](ega-19-properties-title-of-the-study.md))
...
*   Type: `string` ([Description of the study](ega-19-properties-description-of-the-study.md))
...
*   Type: an array of merged types ([Details](ega-19-properties-study-relationships-items.md))
