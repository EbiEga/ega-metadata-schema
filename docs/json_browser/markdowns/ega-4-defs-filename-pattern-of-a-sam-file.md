...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/samFileFilenamePattern
```
...
`string` ([Filename pattern of a SAM file](ega-4-defs-filename-pattern-of-a-sam-file.md))
