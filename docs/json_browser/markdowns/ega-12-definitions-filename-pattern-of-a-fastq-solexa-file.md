...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/definitions/fastq-solexa-file-filename-pattern
```
...
## fastq-solexa-file-filename-pattern Examples
