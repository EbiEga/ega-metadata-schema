...
*   Type: `string` ([Filename pattern of a EXP file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-exp-filename-pattern-check-properties-filename-pattern-of-a-exp-file.md))
