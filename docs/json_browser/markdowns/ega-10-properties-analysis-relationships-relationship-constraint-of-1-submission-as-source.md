...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.analysis.json#/properties/analysis_relationships/contains
```
...
merged type ([Relationship constraint of 1 submission as source](ega-10-properties-analysis-relationships-relationship-constraint-of-1-submission-as-source.md))
