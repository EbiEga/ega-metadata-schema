...
unknown ([TXT Filename patternCheck](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-txt-filename-patterncheck-1.md))
...
*   Type: `string` ([Filename pattern of a TXT file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-txt-filename-patterncheck-1-properties-filename-pattern-of-a-txt-file.md))
...
`string` ([Filename pattern of a TXT file](ega-12-definitions-check-filetype-checks-based-on-its-filename-anyof-txt-filename-patterncheck-1-properties-filename-pattern-of-a-txt-file.md))
