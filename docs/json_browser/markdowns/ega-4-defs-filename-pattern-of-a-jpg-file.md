...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/jpgFileFilenamePattern
```
...
`string` ([Filename pattern of a JPG file](ega-4-defs-filename-pattern-of-a-jpg-file.md))
