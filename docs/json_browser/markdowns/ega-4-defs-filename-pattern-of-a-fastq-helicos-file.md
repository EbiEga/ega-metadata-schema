...
```txt
https://raw.githubusercontent.com/EbiEga/ega-metadata-schema/main/schemas/EGA.common-definitions.json#/$defs/fastqHelicosFileFilenamePattern
```
...
`string` ([Filename pattern of a FASTQ-HELICOS file](ega-4-defs-filename-pattern-of-a-fastq-helicos-file.md))
