...
unknown ([FAM Filename pattern-check](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-fam-filename-pattern-check.md))
...
*   Type: `string` ([Filename pattern of a FAM file](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-fam-filename-pattern-check-properties-filename-pattern-of-a-fam-file.md))
...
`string` ([Filename pattern of a FAM file](ega-2-definitions-check-filetype-checks-based-on-its-filename-anyof-fam-filename-pattern-check-properties-filename-pattern-of-a-fam-file.md))
